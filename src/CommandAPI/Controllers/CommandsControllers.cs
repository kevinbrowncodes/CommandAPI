...
namespace CommandAPI.Controllers
{
    ...
    public class CommandsController : ControllerBase
    {
        ...
        public ActionResult<CommandUpdateDto> UpdateCommand (int id, CommandUpdateDto commandUpdateDto)
        {
            ...
            _mapper.Map(commandUpdateDto, commandModelFromRepo); // where update occurs
            _repository.UpdateCommand(commandModelFromRepo); // makes program implementation agnotstic 
            _repository.SaveChanges();
            return NoContent();
        }
